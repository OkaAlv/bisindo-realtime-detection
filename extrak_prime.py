...
# --- KONFIGURASI FOLDER ---
sumber_video = 'Dataset_Mentah_Primer' 
folder_output = 'dataset_prime_224'
...
print("=== MEMULAI EKSTRAKSI DATASET PRIME DARI TIM ===")
...
for huruf in sorted(os.listdir(sumber_video)):
    ...
    for nama_video in sorted(os.listdir(path_huruf)):
        if not nama_video.lower().endswith(('.mp4', '.mov', '.avi')): continue
        ...
        while cap.isOpened():
            ...
            if results.multi_hand_landmarks:
                ...
                if x_max > x_min and y_max > y_min:
                    ...
                    # PERUBAHAN: Menambahkan kata "prime" di nama file agar mudah dibedakan
                    img_name = os.path.join(output_huruf_dir, f"{huruf}_prime_{nama_file_tanpa_ext}_{saved_count:04d}.jpg")
...
print("\n=== EKSTRAKSI DATASET PRIME SELESAI SELURUHNYA! ===")