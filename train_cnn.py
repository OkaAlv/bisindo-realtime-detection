...
# Memuat data latih (80% dari total gambar)
...
# Memuat data validasi/ujian (20% dari total gambar)
...
# Menyimpan nama-nama kelas (A, B, C, dst) yang dibaca otomatis dari nama folder
...
# Tampilkan ringkasan layer di terminal (Bagus untuk screenshot laporan!)
model.summary()

print("\nMemulai proses training...")
epochs = 10 # Berapa kali AI membaca seluruh dataset (bisa ditambah nanti)
history = model.fit(
  train_ds,
...
# --- 4. SIMPAN MODEL ---
model.save('model_bisindo_statis.h5')
print("\nModel berhasil disimpan dengan nama 'model_bisindo_statis.h5'!")
